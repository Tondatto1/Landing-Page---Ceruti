...
export function HanaAvatar({ className = 'w-full h-full' }: HanaAvatarProps) {
  ...
  // Reset state to try reloading the path when the component mounts or path changes
  useEffect(() => {
    setHasError(false);
  }, []);
  ...
  if (hasError) {
    return (
      ...
      >
        ...
        {/* Grid Pattern inside background */}
        <g opacity="0.15">
        ...
        <path d="M142 180 C150 190, 170 190, 178 180" fill="#fca5a5" opacity="0.4" />
        ...
        <ellipse cx="125" cy="132" rx="10" ry="11" fill="#78350f" />
        <ellipse cx="125" cy="132" rx="7" ry="8" fill="#1c1917" />
        ...
        <ellipse cx="195" cy="132" rx="10" ry="11" fill="#78350f" />
        <ellipse cx="195" cy="132" rx="7" ry="8" fill="#1c1917" />
        ...
        <circle cx="129" cy="177" r="3.5" fill="#111827" />
  ...
  return (
    <img 
      src="/hana-avatar.png" 
      alt="Hana - Assistente Virtual" 
      className={`${className} object-cover select-none`}
      referrerPolicy="no-referrer"
      onError={() => {
        // Fallback to our high-fidelity built-in SVG vector instead of generic image
        setHasError(true);
      }}
    />
  );
...
export function CerutiAvatar({ className = 'w-full h-full' }: HanaAvatarProps) {
  const [hasError, setHasError] = useState(false);
  ...
  if (hasError) {
    return (
      ...
      >
        {/* Background - Soft radial light gradient for portrait pop */}
        <defs>
          <radialGradient id="avatarBgCeruti" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
            <stop offset="0%" stopColor="#ffffff" />
            <stop offset="100%" stopColor="#ecfdf5" /> {/* Mint variant to distinguish */}
          </radialGradient>
          
          <linearGradient id="hairGradCeruti" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#1e293b" />
            <stop offset="50%" stopColor="#334155" />
            <stop offset="100%" stopColor="#0f172a" />
          </linearGradient>

          <linearGradient id="skinGradCeruti" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#fff7ed" />
            <stop offset="100%" stopColor="#ffedd5" />
          </linearGradient>
        </defs>
        ...
        {/* Main outer boundary base */}
        <circle cx="160" cy="160" r="160" fill="url(#avatarBgCeruti)" />

        {/* Grid Pattern inside background */}
        <g opacity="0.1">
          <line x1="40" y1="0" x2="40" y2="320" stroke="#10b981" strokeWidth="1" />
          <line x1="80" y1="0" x2="80" y2="320" stroke="#10b981" strokeWidth="1" />
          <line x1="120" y1="0" x2="120" y2="320" stroke="#10b981" strokeWidth="1" />
          <line x1="160" y1="0" x2="160" y2="320" stroke="#10b981" strokeWidth="1" />
          <line x1="200" y1="0" x2="200" y2="320" stroke="#10b981" strokeWidth="1" />
          <line x1="240" y1="0" x2="240" y2="320" stroke="#10b981" strokeWidth="1" />
          <line x1="280" y1="0" x2="280" y2="320" stroke="#10b981" strokeWidth="1" />

          <line x1="0" y1="40" x2="320" y2="40" stroke="#10b981" strokeWidth="1" />
          <line x1="0" y1="80" x2="320" y2="80" stroke="#10b981" strokeWidth="1" />
          <line x1="0" y1="120" x2="320" y2="120" stroke="#10b981" strokeWidth="1" />
          <line x1="0" y1="160" x2="320" y2="160" stroke="#10b981" strokeWidth="1" />
          <line x1="0" y1="200" x2="320" y2="200" stroke="#10b981" strokeWidth="1" />
          <line x1="0" y1="240" x2="320" y2="240" stroke="#10b981" strokeWidth="1" />
          <line x1="0" y1="280" x2="320" y2="280" stroke="#10b981" strokeWidth="1" />
        </g>

        {/* HAIR BACK */}
        <circle cx="160" cy="55" r="32" fill="url(#hairGradCeruti)" />

        {/* HEADPHONES HEADBAND */}
        <path d="M100 110 C100 50, 220 50, 220 110" stroke="#047857" strokeWidth="7" fill="none" strokeLinecap="round" />

        {/* NECK */}
        <path d="M142 170 C142 170, 142 205, 142 210 C142 210, 160 215, 178 210 C178 205, 178 170, 178 170" fill="#fed7aa" />

        {/* FACE */}
        <path d="M96 128 C96 175, 114 205, 160 205 C206 205, 224 175, 224 128 C224 95, 206 90, 160 90 C114 90, 96 95, 96 128 Z" fill="url(#skinGradCeruti)" />

        {/* CHEEKS BLUSH */}
        <ellipse cx="118" cy="155" rx="14" ry="10" fill="#f87171" opacity="0.2" />
        <ellipse cx="202" cy="155" rx="14" ry="10" fill="#f87171" opacity="0.2" />
        ...
        {/* EYES */}
        <ellipse cx="124" cy="132" rx="14" ry="16" fill="#ffffff" />
        <ellipse cx="125" cy="132" rx="10" ry="11" fill="#0f172a" />
        <circle cx="121" cy="127" r="3.2" fill="#ffffff" />
        <path d="M108 126 C114 120, 134 118, 140 128" stroke="#1f2937" strokeWidth="4" strokeLinecap="round" fill="none" />

        <ellipse cx="196" cy="132" rx="14" ry="16" fill="#ffffff" />
        <ellipse cx="195" cy="132" rx="10" ry="11" fill="#0f172a" />
        <circle cx="191" cy="127" r="3.2" fill="#ffffff" />
        <path d="M212 126 C206 120, 186 118, 180 128" stroke="#1f2937" strokeWidth="4" strokeLinecap="round" fill="none" />

        {/* MOUTH - FRIENDLY SMILE */}
        <path d="M130 165 C130 165, 160 190, 190 165" stroke="#1e293b" strokeWidth="3.5" strokeLinecap="round" fill="none" />

        {/* HAIR FRONT */}
        <path d="M96 120 C105 105, 130 96, 160 102 C190 96, 215 105, 224 120 Z" fill="url(#hairGradCeruti)" />

        {/* HEADPHONES EAR CUPS */}
        <rect x="83" y="110" width="14" height="38" rx="7" fill="#065f46" />
        <rect x="223" y="110" width="14" height="38" rx="7" fill="#065f46" />

        {/* CLOTHES: CRISP WHITE COLLAR BUTTON SHIRT */}
        <path d="M102 240 L218 240 L234 320 L86 320 Z" fill="#ffffff" stroke="#cbd5e1" strokeWidth="1" />
        <path d="M142 210 L146 235 L120 220 Z" fill="#f8fafc" stroke="#cbd5e1" strokeWidth="1.5" strokeLinejoin="round" />
        <path d="M178 210 L174 235 L200 220 Z" fill="#f8fafc" stroke="#cbd5e1" strokeWidth="1.5" strokeLinejoin="round" />
